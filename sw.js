...
const CACHE_NAME = 'yayi-nails-saln-y-spa-v49';
const urlsToCache = [
  ...
  '/yayi-nails-saln-y-spa/calendar.html',
  ...
  '/yayi-nails-saln-y-spa/vendor/react.production.min.js',
  '/yayi-nails-saln-y-spa/vendor/react-dom.production.min.js',
  '/yayi-nails-saln-y-spa/vendor/babel.min.js',
  '/yayi-nails-saln-y-spa/vendor/bcrypt.min.js',
  '/yayi-nails-saln-y-spa/vendor/tailwind-browser.js',
  '/yayi-nails-saln-y-spa/vendor/lucide/lucide.css',
  '/yayi-nails-saln-y-spa/vendor/lucide/lucide.woff2',
  '/yayi-nails-saln-y-spa/utils/push-config.js',
  '/yayi-nails-saln-y-spa/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/yayi-nails-saln-y-spa/icons/icon-192x192.png',
    badge: '/yayi-nails-saln-y-spa/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/yayi-nails-saln-y-spa/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/yayi-nails-saln-y-spa/admin.html';
  event.waitUntil(
